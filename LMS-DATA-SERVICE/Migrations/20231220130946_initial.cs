        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingsAverage = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Benefits_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoSection = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VideoLength = table.Column<int>(type: "int", nullable: false),
                    VideoPlayer = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseDatas_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CourseDataId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_CourseDatas_CourseDataId",
                        column: x => x.CourseDataId,
                        principalTable: "CourseDatas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Links_CourseDatas_CourseDataId",
                        column: x => x.CourseDataId,
                        principalTable: "CourseDatas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Reply_EitherCommentOrReview", "([CommentId] IS NOT NULL AND [ReviewId] IS NULL) OR ([CommentId] IS NULL AND [ReviewId] IS NOT NULL)");
                    table.ForeignKey(
                        name: "FK_Relies_Comments_CommentId",
                        column: x => x.CommentId,
                        principalTable: "Comments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Relies_Reviews_ReviewId",
                        column: x => x.ReviewId,
                        principalTable: "Reviews",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Relies_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Benefits_CourseId",
                table: "Benefits",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_CourseDataId",
                table: "Comments",
                column: "CourseDataId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseDatas_CourseId",
                table: "CourseDatas",
                column: "CourseId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Links_CourseDataId",
                table: "Links",
                column: "CourseDataId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Relies_CommentId",
                table: "Relies",
                column: "CommentId");

            migrationBuilder.CreateIndex(
                name: "IX_Relies_ReviewId",
                table: "Relies",
                column: "ReviewId");

            migrationBuilder.CreateIndex(
                name: "IX_Relies_UserId",
                table: "Relies",
                column: "UserId");
